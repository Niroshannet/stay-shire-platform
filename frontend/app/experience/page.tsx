        ...
        <div className="min-h-screen bg-white pt-20">
            ...
            <div className="bg-gradient-to-br from-[#059669] to-[#047857] text-white py-16">
                <div className="max-w-7xl mx-auto px-4">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">Host an Experience</h1>
                    <p className="text-xl text-green-50 max-w-2xl">
                        Share your passion and expertise. Create unique experiences for travelers.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-12">
                <div className="grid md:grid-cols-3 gap-6">
                    <div className="bg-gray-50 rounded-xl p-6">
                        <Sparkles className="w-12 h-12 text-[#059669] mb-4" />
                        <h3 className="text-xl font-semibold mb-2">Share Your Passion</h3>
                        <p className="text-gray-600">Teach cooking, lead tours, host workshops, and more.</p>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-6">
                    ...
                    <div className="bg-gray-50 rounded-xl p-6">
                        ...
                        <p className="text-gray-600">Host on your own schedule and terms.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gray-50 py-12">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">Start Hosting Experiences</h2>
                    <Link
